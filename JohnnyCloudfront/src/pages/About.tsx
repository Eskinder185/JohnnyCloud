  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
        ...
        {/* Johnny-5 Robot Section */}
        <Card className="p-10 grid place-items-center min-h-[400px] border border-dashed border-[rgba(255,255,255,.18)]">
          <div className="text-center">
            <JohnnyBot className="mx-auto mb-4" />
            <div className="text-jc-dim">
              <div className="font-semibold text-white mb-1">Drop Johnny-5 render here</div>
              <div className="text-sm">Robot character placeholder</div>
            </div>
          </div>
        </Card>
      </div>
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            <div className="w-16 h-16 bg-jc-yellow rounded-full flex items-center justify-center text-white font-bold text-xl mx-auto mb-4">
              02
            </div>
      ...
      <Card className="p-8 text-center">
        ...
        <p className="text-jc-dim text-sm">
          Questions? Reach out to our team at <span className="text-jc-cyan">hello@johnnycloud.io</span>
        </p>
      </Card>
    </>
  )
